...
/* harmony default export */ var Game = ({
  ...
  data: function data() {
    return {
      rewardList: [{ name: 'again', repeat: true }, { name: 'Han', repeat: false }, { name: 'Chen', repeat: false }, { name: 'Li', repeat: false }, { name: 'Ling', repeat: false }, { name: 'Kang', repeat: false }, { name: 'next', repeat: true }],
      index: 0,
      isnoreapt: false,
      name: '',
      isrepeat: false,
...
//# sourceMappingURL=app.74608f60fe8326be5ebb.js.map