...
/* harmony default export */ var Game = ({
  ...
  data: function data() {
    return {
      rewardList: [{ name: 'again', repeat: true }, { name: 'Han', repeat: false }, { name: 'Chen', repeat: false }, { name: 'Li', repeat: false }, { name: 'Ling', repeat: false }, { name: 'Kang', repeat: false }, { name: 'nnnext', repeat: true }],
      index: 0,
      isnoreapt: false,
      name: '',
      isrepeat: false,
  ...
  methods: {
    addname: function addname() {
      ...
      this.rewardList.push({ name: this.name, repeat: this.isrepeat });
      this.$nextTick(function () {
    ...
    openRule: function openRule() {
      ...
      document.querySelector('.triangle').style.transform = document.querySelector('.triangle').style.transform === 'rotate(0deg)' ? 'rotate(-180deg)' : 'rotate(0deg)';
    },
    restart: function restart() {
      this.isnoreapt = false;
      this.start();
    },
    start: function start() {
      ...
      this.disable = true;
      // if (this.rewardList[this.index].repeat <= 1) {
      //   alert('已結束 請返回重新開始')
      //   return
      // }
      if (this.isnoreapt && !this.rewardList[this.index].repeat) {
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/template-compiler?{"id":"data-v-453650a1","hasScoped":false,"transformToRequire":{"video":["src","poster"],"source":"src","img":"src","image":"xlink:href"},"buble":{"transforms":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./src/views/Game.vue
var Game_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"game bg-first d-flex align-items-center justify-content-center"},[(_vm.gameshow)?_c('div',{staticClass:"w-75 p-3 mx-auto bg-first-light align-items-center justify-content-center"},[_c('p'),_vm._v(" "),_c('div',{staticClass:"bg-white font-weight-bold p-3 text-second h7 my-3 rounded"},[_c('div',{staticClass:"d-flex justify-content-center"},[_c('p',{staticClass:"text-center"},[_vm._v(" "+_vm._s(_vm.rewardList[_vm.index].name)+" ")])])]),_vm._v(" "),_c('div',{staticClass:"d-flex justify-content-center text-gray text-center"},[_c('div',{staticClass:"enter-btn bg-first-light mr-3",on:{"click":_vm.start}},[_vm._v("開始抽獎")]),_vm._v(" "),_c('div',{staticClass:"enter-btn bg-first-light",on:{"click":_vm.restart}},[_vm._v("再抽一次")])]),_vm._v(" "),_c('div',{staticClass:"bg-first text-center p-1 text-white my-3 rounded",on:{"click":_vm.openRule}},[_vm._v("\n      規則說明\n      "),_c('span',{staticClass:"ml-2 triangle position-absolute",attrs:{"id":"faq9"}})]),_vm._v(" "),_c('transition',{attrs:{"name":"slide-fade"}},[(_vm.showRule)?_c('div',{staticClass:"p-2 text-dark-gray"},[_vm._v("\n        若按開始抽獎，抽過的獎項將不重複出現且刪除;若按在抽一次，該次抽獎將被保留且繼續再抽下一個。"),_c('br'),_vm._v("\n        若需更改獎項名稱可自行更改刪除\n      ")]):_vm._e()]),_vm._v(" "),_c('div',{staticClass:"w-50 enter-btn bg-white text-gray text-center rounded mx-auto text-center",on:{"click":function($event){_vm.gameshow = false}}},[_vm._v("返回")])],1):_c('div',{staticClass:"p-5 text-center"},[_c('p',{staticClass:"h7 mb-3 text-white"},[_vm._v("幸運抽獎器")]),_vm._v(" "),_c('div',{staticClass:"d-flex justify-content-between align-items-center mb-3"},[_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.name),expression:"name"}],attrs:{"type":"text","placeholder":"Enter your reward"},domProps:{"value":(_vm.name)},on:{"input":function($event){if($event.target.composing){ return; }_vm.name=$event.target.value}}}),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.isrepeat),expression:"isrepeat"}],staticClass:"mx-2",attrs:{"type":"checkbox"},domProps:{"checked":Array.isArray(_vm.isrepeat)?_vm._i(_vm.isrepeat,null)>-1:(_vm.isrepeat)},on:{"change":function($event){var $$a=_vm.isrepeat,$$el=$event.target,$$c=$$el.checked?(true):(false);if(Array.isArray($$a)){var $$v=null,$$i=_vm._i($$a,$$v);if($$el.checked){$$i<0&&(_vm.isrepeat=$$a.concat([$$v]))}else{$$i>-1&&(_vm.isrepeat=$$a.slice(0,$$i).concat($$a.slice($$i+1)))}}else{_vm.isrepeat=$$c}}}}),_vm._v(" "),_c('div',{staticClass:"enter-btn bg-first-light",on:{"click":_vm.addname}},[_vm._v("Add")])]),_vm._v(" "),(_vm.rewardList.length > 0)?_c('div',{staticClass:"text-left p-2 bg-first-light name-list"},_vm._l((_vm.rewardList),function(item,index){return _c('div',{key:index,staticClass:"m-2 d-flex justify-content-between align-items-center"},[_c('p',{staticClass:"text-gray mb-0"},[_vm._v(_vm._s(index + 1)+". "+_vm._s(item.name))]),_vm._v(" "),_c('p',{staticClass:"text-white mb-0"},[_vm._v(_vm._s(item.repeat?'Repeat':''))]),_vm._v(" "),_c('p',{staticClass:"text-first p-1 rounded h5 mb-0 bg-white",on:{"click":function($event){return _vm.delName(index)}}},[_vm._v("Del")])])}),0):_vm._e(),_vm._v(" "),(_vm.rewardList.length > 0)?_c('div',{staticClass:"mt-5 mx-5 enter-btn bg-first-light text-center text-gray",on:{"click":function($event){_vm.gameshow = true}}},[_vm._v("START")]):_vm._e()])])}
...
//# sourceMappingURL=app.995ff9d8bb501618b087.js.map