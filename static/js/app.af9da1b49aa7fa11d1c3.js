...
/* harmony default export */ var Game = ({
  ...
  data: function data() {
    return {
      rewardList: [],
      keepList: [{ name: 'NEXT', repeat: true }, { name: 'Han', repeat: false }, { name: 'Chen', repeat: false }, { name: 'Li', repeat: false }, { name: 'Ling', repeat: false }, { name: 'Kang', repeat: false }],
      sortList: [],
      index: 0,
      isnorepeat: false,
      name: '',
  ...
  methods: {
    ...
    endgame: function endgame() {
      ...
      this.sortList = [];
      this.rewardList = [];
      (_rewardList3 = this.rewardList).push.apply(_rewardList3, toConsumableArray_default()(this.keepList));
      console.log('157');
    },
...
//# sourceMappingURL=app.af9da1b49aa7fa11d1c3.js.map